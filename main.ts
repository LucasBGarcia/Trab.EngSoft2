...
while (option < 7){
    ...
    switch (option){
        case 1:     
        let quantCap = +teclado('Digite o número de capítulos a cadastrar: ')
        //let livro: Livro = new Livro(livro.adicionarCapitulo, livro.adicionarISBN, livro.adicionarAutor)
        break
        case 2: 

        break
        case 3: 
            console.log(livro.list())
        break
        case 4: 
